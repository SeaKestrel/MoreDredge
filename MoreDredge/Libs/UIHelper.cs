...
namespace MoreDredge.UI
{
    ...
    {
        public static void FireOnNextUpdate(Action action) => MoreDredge.Instance.StartCoroutine(FireOnNextUpdateEnumerator(action));
        ...
        public static void RunWhen(Func<bool> predicate, Action action) => MoreDredge.Instance.StartCoroutine(RunWhenEnumerator(predicate, action));
        ...
        public static void FireInNUpdates(int n, Action action) => MoreDredge.Instance.StartCoroutine(FireInNUpdatesEnumerator(n, action));
